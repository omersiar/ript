...
- You need a compacted topic (configured via `RIPT_STATE_TOPIC`) for RIPT's state storage, **RIPT can create this topic if allowed**, otherwise provision it with a lower segment.ms, 86400000 (1 day) is recommended
