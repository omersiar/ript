...
Do you know when "the ever increasing offset" is exhausted for a partition? Not in your lifetime — even at one million messages per second, a partition's offset would take [about 290 years to exhaust](https://kafka.apache.org/42/design/protocol/#protocol-primitive-types/).

Do you know when does "the ever increasing number of partitions" become an issue? ZK-based clusters become unstable beyond ~200,000 partitions; KRaft-based clusters raise that ceiling significantly, with two million partitions [tested in a lab](https://docs.confluent.io/platform/current/kafka-metadata/kraft.html#scaling-ak-with-kraft).
...
[![RIPT](ript.png)](https://github.com/omersiar/ript.git)
