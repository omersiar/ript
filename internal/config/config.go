...
func (c *Config) String() string {
	return fmt.Sprintf("Config{Brokers: %v, ScanInterval: %dm, StateTopic: %s, ConsumerGroupID: %s, GroupSessionTimeoutMS: %d, GroupHeartbeatMS: %d, GroupRebalanceTimeoutMS: %d, TimestampSource: %s, EventHeader: %s, EventLookupTimeoutMS: %d, Partitions: %d, RF: %d, StateLoadTimeout: %ds, InstanceID: %s, HTTPPort: %d, LogLevel: %s, StaleDays: %d, UnusedDays: %d, HeartbeatInterval: %ds, ConnectRetry: %ds}",
		...
		c.TrackerTopicPartitions, c.TrackerTopicReplicationFactor, c.StateLoadTimeoutSeconds,
